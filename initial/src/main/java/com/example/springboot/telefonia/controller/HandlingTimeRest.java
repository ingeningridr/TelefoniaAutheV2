...
public class HandlingTimeRest {
    ...
    public String sendHandlingTimeRest(
      ...
      @RequestParam("average_talk_time_in") Date Average_talk_time_in) {
        ...
        return "idHT" + IdHT + "dini " +DIni+ "dFin " + DFin + "service" +Service+ "start_name " +Start_name+ "service_name " + Service_name + "handling_time" + Handling_time+ "average_handling_time " +Average_handling_time+ "talk_time_in " + Talk_time_in + "average_talk_time_in" + Average_talk_time_in +"";
